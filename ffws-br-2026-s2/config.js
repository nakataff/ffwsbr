window.FFWS_BR_2026_S2_CONFIG = Object.freeze({
  teamsUrl: 'ffws-br-2026-s2/teams.json?v=20260727-s2-v1',
  stagesUrl: 'ffws-br-2026-s2/stages.json?v=20260727-s2-v1',
  playersUrl: 'ffws-br-2026-s2/players.json?v=20260727-s2-v1',
  datesUrl: 'ffws-br-2026-s2/dates.json?v=20260727-s2-v1',
  layout: {
    classificatoria: {
