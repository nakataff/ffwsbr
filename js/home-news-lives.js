...
function ensureHomeConfrontationSummaryButton() {
    ...
    const oldInlineButtons = Array.from(document.querySelectorAll('button, a')).filter(el => {
        ...
        return txt.includes('resumo do confronto') || txt.includes('possibilidade da final') || txt.includes('possibilidade das finais') || txt.includes('probabilidades da final') || onclick.includes('openHomeConfrontoResumoModal') || onclick.includes('openHomeConfrontationSummary') || onclick.includes("navigate('final')");
    });
