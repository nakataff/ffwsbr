...
function createPlayerCardHTML(p, scale = 1) {
    ...
    let flagSrc = "br.png";
    try {
        flagSrc = (typeof otGetPlayerFlagSrc === 'function') ? otGetPlayerFlagSrc(p.jogador, p.flag || p.pais || 'br') : 'br.png';
    } catch (e) {
        flagSrc = 'br.png';
    }
    ...
    return `
        <div onclick="${_safePPAttr(p.jogador)}" style="cursor:pointer; width: 280px; height: 420px; background: #000; border: 3px solid ${accentColor}; border-radius: 15px; position: relative; overflow: hidden; font-family: sans-serif; ${glow} ${marginStyle}">
            ...
            <div style="position: absolute; top: 40px; left: 25px; z-index: 4; text-align: center; color: ${accentColor};">
                ...
                <img src="${flagSrc}" loading="lazy" decoding="async" fetchpriority="low" onerror="this.onerror=null;this.src='br.png'" style="width: 35px; border-radius: 2px; display: block; margin: 8px auto;">
            ...
            <img src="${photo}" loading="lazy" decoding="async" fetchpriority="low" onerror="this.src='silhueta.png'" style="position: absolute; top: 20px; right: -30px; height: 260px; z-index: 2; -webkit-mask-image: linear-gradient(to bottom, black 70%, transparent 100%);">
