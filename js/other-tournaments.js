...
function renderOtTabs() {
    ...
    if (otGetPrizeSections(currentOtData).length) options.push(['prize', 'Premiação']);
            ...
            if (section.type === 'awardPrizePool') {
                return `
                    <tr>
                        ...
                        <td class="ot-team-click" onclick="openOtTeamRoster('${otEscapeHTML(currentOtData.id)}', '${otEscapeHTML(team)}')"><img src="${otEscapeHTML(logo)}" onerror="this.src='escudo.webp'"><span>${otEscapeHTML(team)}</span></td>
