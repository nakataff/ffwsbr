...
(function () {
    ...
    function renderLAFFEquipesPage() {
        ...
        if (!root) return;
        const teamOptions = laffTeams.length
        ...
        root.innerHTML = `${laffHero('Equipes', 'Equipes confirmadas na LAFF')}
            ...
            <div style="display:flex;gap:10px;flex-wrap:wrap;align-items:center;">
                ...
                <select id="laff-player-team-filter" class="laff-search" onchange="renderLAFFPlayers()" style="flex:1;min-width:140px;">${teamOptions}</select>
            </div></div>
            <div id="laff-players-wrap"></div></section>`;
