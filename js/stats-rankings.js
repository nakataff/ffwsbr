...
async function openTeamProfile(teamName) {
    ...
    if (typeof loadFinalDataSafe === 'function' && (typeof dbFinalQuedas === 'undefined' || !dbFinalQuedas || !Object.keys(dbFinalQuedas).length)) {
    ...
    const finalInfo = (typeof cffGetTeamFinalProfileInfo === 'function') ? cffGetTeamFinalProfileInfo(t.equipe || teamName) : null;
    ...
    document.getElementById('tp-pos').innerText = finalInfo ? `${finalInfo.rank}º` : ((t.posGeral === "-") ? "N/A" : `${t.posGeral}º`);
    if (typeof cffRenderTeamFinalStatus === 'function') cffRenderTeamFinalStatus(t.equipe || teamName, finalInfo);
