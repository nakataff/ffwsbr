...
function openTeamProfile(teamName) {
    ...
    if (logoEl) {
        const logoName = (typeof getTeamCanonicalName === 'function') ? getTeamCanonicalName(t.equipe) : t.equipe;
        logoEl.src = logos[t.equipe] || logos[logoName] || logos[teamName] || 'escudo.webp';
