...
function renderHistoricoEquipes(nome, containerId) {
    ...
    container.innerHTML = passagensArray.map((passagem, index) => {
        ...
        let isClickable = typeof db !== 'undefined' && db.teams && db.teams.some(t => typeof sameTeamName === 'function' ? sameTeamName(t.equipe, resolvedEquipe) : t.equipe.toUpperCase() === equipeUpper);
        ...
        let clickAction = isClickable ? `onclick="openTeamProfile('${resolvedEquipe}')"` : '';
