...
async function openTeamProfile(teamName) {
    ...
    // Não trava a abertura do perfil esperando planilhas auxiliares.
    // Mercado, passagens e novos torneios atualizam a página em segundo plano.
    if (typeof cffApplyMercadoDeparturesToCurrentPlayers === 'function') {
    ...
    if (typeof cffQueueTeamProfileSupplementalLoads === 'function') cffQueueTeamProfileSupplementalLoads(t.equipe || teamName);
}
