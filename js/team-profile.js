...
let officialName = cffCanonicalPlayerDisplayName(safeName);
    ...
    const mergedPlayerEditions = cffMergeLAFFPlayerHistoryIntoEditions(p.jogador, cffMergeCurrentEditionIntoEditions(p.jogador, playerEntries ? playerEntries[1] : {}, p));
