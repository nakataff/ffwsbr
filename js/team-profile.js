...
let officialName = cffCanonicalPlayerDisplayName(safeName);
    ...
    cffRenderPlayerEditionBreakdown(playerEntries ? playerEntries[1] : null);
...
if (typeof renderPlayerCFFRating === 'function') renderPlayerCFFRating(p.jogador);
    ...
    if (typeof renderPlayerHistorySummary === 'function') renderPlayerHistorySummary(p.jogador, { isInactive: isInactive || !!playerMercadoExit, currentTeam: playerMercadoExit ? '' : equipeAtual, lastEdition: lastEd, mercadoExit: playerMercadoExit });
