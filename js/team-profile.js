    ...
    if (!players.length) {
        section.innerHTML = `
            <div class="team-history-head">
                <div>
                    <div class="team-history-kicker">História</div>
                    <h3>Histórico de jogadores</h3>
                </div>
            </div>
    ...
    section.innerHTML = `
        ...
        <div class="team-history-subsection">
            <div class="team-history-subtitle-row">
                ...
                <p>Quem está jogando a WB atual aparece normal. Quem está ativo em outra equipe aparece com a logo atual. Quem está fora aparece em preto e branco.</p>
            </div>
