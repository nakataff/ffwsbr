...
function renderCompareTeams() {
    ...
    result.innerHTML = `
        ...
        <div style="grid-column: span 2; background:var(--panel-bg); border-radius:8px; padding:15px; border:1px solid var(--border);">
            ...
            ${buildRow('Abates totais', t1.abates, t2.abates, v => Math.round(Number(v || 0)))}
            ${buildRow('Total Quedas', t1.quedas, t2.quedas, v => Math.round(Number(v || 0)), { neutral: true })}
...
function renderComparePlayers() {
    ...
    result.innerHTML = `
        ...
        <div style="grid-column: span 2; background:var(--panel-bg); border-radius:8px; padding:15px; border:1px solid var(--border);">
            ...
            ${buildRow('Abates totais', p1.abates || 0, p2.abates || 0, p1.rankKills, p2.rankKills, v => Math.round(Number(v || 0)))}
            ...
            ${buildRow('Kills/Queda', kq1, kq2, null, null, v => Number(v || 0).toFixed(2))}
        </div>`;
}
